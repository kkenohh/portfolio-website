...
const services = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. blah blah blah",
    href: "",
  },
  {
    num: "02",
          ...
          {services.map((service, index) => {
            return (
              ...
              >
                ...
                <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent transition-all duration-200">
                  {service.title}
                </h2>
